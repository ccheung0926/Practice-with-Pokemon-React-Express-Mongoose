	...
	var Pokedex = function (_React$Component) {
	  ...
	  _createClass(Pokedex, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _axios2.default.get('/api/pokedex').then(function (res) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          null,
	          this.state.data.map(function (pokemon) {
	            return _react2.default.createElement('li', { key: pokemon.name });
	          })
	        )
	      );
	    }
...
//# sourceMappingURL=0.0942beea291bb8630ce6.hot-update.js.map